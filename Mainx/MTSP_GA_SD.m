%% MTSP GA iteration based function using multi-chromosome representation

function varargout = MTSP_GA_SD(xy,dmat,robots,min_tour,max_tour,weight_F2,tw,pop_size,num_iter,use_complex,show_prog,show_res,clr)
...
for iter = 1:num_iter  % Evaluate Members of the Population
    ...
    for i=1:pop_size
        ...
        if total_dist_F2(i) < cases_min_F2(number_of_robot) && total_dist(i) < 1e20
