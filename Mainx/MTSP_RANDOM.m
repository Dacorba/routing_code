...
for max_iteration = iter_tests % number of iterations for the loop, calculate minimal distance
        ...
        while iteration < max_iteration
            ...
            %calculating the distance considering random combinations
                ...
                %if quantidade de robos em seq_robots != robots
                %=> mudamos seq_robots aletoriamente até que a que a queantidade
                %de robos seja = robots
                ...
                % case the distances for each robot were 
                % smaller then de max distance allowed,
                ...
                if prox == 0
                    ...
                    if (1-weight_F2)*total_current_distance + weight_F2*(max_dist_robot - min_dist_robot)...
