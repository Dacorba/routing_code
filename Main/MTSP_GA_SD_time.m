function varargout = MTSP_GA_SD_time(xy,dmat,robots,min_route,max_distance,weight_wdm,max_time,pop_size,num_iter,use_complex,show_prog,show_res,clr)
% Variation of the MTSP_GA_SD function. The algorithm and outputs are
% the same, but a new input is added: max_time. Thus, now this algorithm 
% calculates based on a time limit instead of an iteration limit.
...
cases_routes_min = cell(1,robots); %definir cá é só para debugging
